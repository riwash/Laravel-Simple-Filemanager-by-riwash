                              ...
                              <div class="col">
                                    <div class="card h-100 file-card">
                                          ...
                                          <div class="card-body">
                                                ...
                                                <a href="{{ $file->url }}" target="_blank" class="btn btn-sm btn-primary" title="View">
                                                      <i class="bi bi-eye"></i>
                                                </a>

                                                <!-- Edit Button -->
                                          <button class="btn btn-sm btn-info edit-btn" data-bs-toggle="modal" data-bs-target="#editModal"
                                                data-id="{{ $file->id }}" data-title="{{ $file->title ?? '' }}" title="Edit">
                                                <i class="bi bi-pencil-square"></i>
                                          </button>


                                                <form action="{{ route('file-manager.destroy', $file->id) }}" method="POST" style="display:inline-block;">
                                                      @csrf
                                                      @method('DELETE')
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
      <div class="modal-dialog">
            <form id="editForm" method="POST" action="{{ route('file-manager.edit') }}">
                  @csrf
                  @method('PUT')
                  <div class="modal-content">
                        <div class="modal-header">
                              <h5 class="modal-title" id="editModalLabel">Edit File Title</h5>
                        ...
                        <div class="modal-body">
                              <input type="text" name="title" id="modalTitle" class="form-control"
                                    ...
                                    <input type="hidden" name="id" id="modalId" class="form-control" required>
                        </div>
      ...
      <script>
            $(document).ready(function () {
                  ...
                  $('#editModal').on('show.bs.modal', function (event) {
                        ...
                        const fileId = button.data('id');      // get data-id
                        const title = button.data('title');    // get data-title
